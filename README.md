...
当前活动版本 15 只属于运行链路影子验证；它复用版本 11 的冻结权重，
...
当前可信运行影子为版本 15，绑定代码提交 `41b2cfa` 和验证哈希
`917b82e025e43f7049ed38caceb92ffe52a679cedd3c47cd053c0c52a4007398`。
空账户 7 的观察期为 2026-08-06～2026-10-06；首日只生成信号，连续优化的
26 只目标经 A 股整手离散后形成 23 只可执行目标，股票仓位 90.9591%，其余
持有现金，需等下一真实交易日开盘模拟执行。版本 13 因运行代码与冻结提交
不一致、版本 14 因连续权重未离散即进入前向信号均已退役，相关运行只保留作
事故审计。详细证据见
[`docs/strategy-v15-operational-shadow-20260806.md`](docs/strategy-v15-operational-shadow-20260806.md)。
