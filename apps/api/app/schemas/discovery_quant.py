...
class FactorBoardItem(ConfiguredBaseModel):
    ...
    return_1m: float | None = Field(default=None, description="近 1 个自然月总收益（含分红）")
    return_3m: float | None = Field(default=None, description="近 3 个自然月总收益（含分红）")
    return_1y: float | None = Field(default=None, description="近 1 个自然年总收益（含分红）")
    return_3y: float | None = Field(default=None, description="近 3 个自然年总收益（含分红）")
